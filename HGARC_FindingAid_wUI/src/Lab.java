...
public class Lab extends JPanel implements ActionListener
{
    ...
    public void actionPerformed(ActionEvent e) 
    {
        ...
        if (e.getSource() == fileButton) 
        {
        	...
        	int input = fc.showOpenDialog(Lab.this);
            ...
            if (input == JFileChooser.APPROVE_OPTION) 
            {
                ...
                try 
                {
					if(FilenameUtils.getExtension(spreadsheet.getPath()).equals("xlsx"))
					{
						...
						input = fc.showOpenDialog(Lab.this);
		    			if(input == JFileChooser.APPROVE_OPTION)
		    			{
    ...
    private static String scanWrite(File spreadsheet) throws Exception //Scans an Excel spreadsheet and converts it into a Word document
	{
        ...
        try
        {
			...
			*/
	        ...
	        wb.close();
	        log.append("Congrats, you ran the code like a normal person." + newline);
        }
        catch(Exception e)
        {
